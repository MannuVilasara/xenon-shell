...
ColumnLayout {
    ...
    GridLayout {
        ...
        Repeater {
            model: [
                { icon: "󰖎", label: "Humidity", val: WeatherService.humidity },
                { icon: "󰖝", label: "Wind", val: WeatherService.wind },
                { icon: "󰖒", label: "Pressure", val: "1012 hPa" }, // Mock
                { icon: "󰖕", label: "UV Index", val: "3" }  // Mock
            ]
            ...
            Rectangle {
                ...
                RowLayout {
                    ...
                    ColumnLayout {
                        spacing: 0
                        Text { text: modelData.label; color: theme.subtext; font.pixelSize: 10 }
                        Text { text: modelData.val; color: theme.fg; font.pixelSize: 12; font.bold: true }
                    }
                }
            }
        }
